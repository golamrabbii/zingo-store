    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Edit district</h4>
                  ...
                  <form class="forms-sample" action="{{ url('update_district', $district->id) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="exampleInputName1">District name</label>
                      <input type="text" name="name" class="form-control" id="exampleInputName1" value="{{ $district->name }}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Division</label>
                      <select class="form-control" name="division_id">
                        <option value="">Select a division for this ditrict</option>

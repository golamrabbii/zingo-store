            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p>
                  	<a href="{{ url('/add_category') }}" style="text-decoration: underline; font-size: 13px; float: right;
                  	margin-bottom: 20px; ">+ Add categories</a>
                  </p>
                      ...
                      @foreach ($category as $category)
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <a class="custom_edit" href="{{ url('/edit_category', $category->id) }}">
                                <i class="fa fa-pencil-square-o" style="padding-right: 10px;"></i>
                              </a>
                              {{-- <a href="{{ url('/show_category', $category->id) }}">
                                <i class="fa fa-eye" style="color: var(--success); padding-right: 10px; font-size: 15px;"></i></a> --}}
                              <a class="custom_delete" href="#deleteModal{{ $category->id }}" data-toggle="modal">
